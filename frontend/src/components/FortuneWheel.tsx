        ...
        <div className={className}>
            <div className="flex flex-col items-center gap-4">
                ...
                <button
                    ...
                    onClick={handleSpin}
                    disabled={mustSpin}
                    className="pointer-events-auto rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white shadow transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
                >
